...
├── .claude/              # Claude Code integrations (project-scoped)
├── .agents/              # Generic agent workflows and skills
...
| **AGENTS.md**                               | Project rules for all AI coding agents (hard rules, conventions, scenarios)              |
| **CLAUDE.md**                               | Claude Code harness-specific additions that defer to `AGENTS.md`                         |
| **GEMINI.md**                               | Gemini harness-specific additions that defer to `AGENTS.md`                              |
...
| `_tasks/superpowers/` | Plans/specs from superpowers (`writing-plans`/`brainstorming`) + research — isolated, separately-versioned repo, gitignored by the main tree. See AGENTS.md → "Planning & Research Artifacts". |
